...
class GameActivity : AppCompatActivity() {
    ...
    private fun updateUI(gameState: GameState) {
        when (gameState) {
            ...
            is GameState.Running -> {
                ...
                lettersUsedTextView.text = "Letras usadas: ${gameState.lettersUsed}"
    ...
    private fun showGameLost(wordToGuess: String) {
        ...
        imageView.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.img7))
